...
PKG = 'Liquirizia.WebClient'
SRC = 'src'
EXCLUDES = []
DESC = 'Web Client Application of Python Modernized Application Framework Liquirizia'
WHO = 'Heo Yongseon'
...
setup(
	...
	classifiers=[
		...
		'Application Framework :: Liquirizia :: WebApplication :: WebClient',
	],
	install_requires=[
